function Strings( config ) {
	...
	const values = {
		...
		en: {
			...
			'sidebar/mapMore/wrapModeOptions/clampToEdgeWrapping': '(default)ClampToEdgeWrapping',
			'sidebar/mapMore/wrapModeOptions/mirroredRepeatWrapping': 'MirroredRepeatWrapping',
			'sidebar/mapMore/minFilterLabel': 'MinFilter',
			'sidebar/mapMore/minFilterOptions/nearestFilter': 'NearestFilter',
			'sidebar/mapMore/minFilterOptions/nearestMipmapNearestFilter': 'NearestMipmapNearestFilter',
			'sidebar/mapMore/minFilterOptions/nearestMipmapLinearFilter': '(default)NearestMipmapLinearFilter',
			'sidebar/mapMore/minFilterOptions/linearFilter': 'LinearFilter',
			'sidebar/mapMore/minFilterOptions/linearMipmapNearestFilter': 'LinearMipmapNearestFilter',
			'sidebar/mapMore/minFilterOptions/linearMipmapLinearFilter': 'LinearMipmapLinearFilter',
			'sidebar/mapMore/magFilterLabel': 'MagFilter',
			'sidebar/mapMore/magFilterOptions/nearestFilter': 'NearestFilter',
			'sidebar/mapMore/magFilterOptions/linearFilter': '(default)LinearFilter',
			'sidebar/mapMore/mappingLabel': 'Mapping',
			'sidebar/mapMore/mappingOptions/uvMapping': '(default)UVMapping',
			'sidebar/mapMore/mappingOptions/cubeReflectionMapping': 'CubeReflectionMapping',
			'sidebar/mapMore/mappingOptions/cubeRefractionMapping': 'CubeRefractionMapping',
			'sidebar/mapMore/mappingOptions/equirectangularReflectionMapping': 'EquirectangularReflectionMapping',
			'sidebar/mapMore/mappingOptions/equirectangularRefractionMapping': 'EquirectangularRefractionMapping',
			'sidebar/mapMore/mappingOptions/cubeUVReflectionMapping': 'CubeUVReflectionMapping',
		...
		zh: {
			...
			'sidebar/mapMore/wrapModeOptions/clampToEdgeWrapping': '(默认)边缘像素延申',
			'sidebar/mapMore/wrapModeOptions/mirroredRepeatWrapping': '镜像平铺包裹',
			'sidebar/mapMore/minFilterLabel': '缩小滤镜(minFilter)',
			'sidebar/mapMore/minFilterOptions/nearestFilter': '取最接近像素值',
			'sidebar/mapMore/minFilterOptions/nearestMipmapNearestFilter': '取最匹配MipMap的最接近像素值',
			'sidebar/mapMore/minFilterOptions/nearestMipmapLinearFilter': '(默认)取2个最匹配MipMap的最接近像素值的加权平均值',
			'sidebar/mapMore/minFilterOptions/linearFilter': '取相邻像素加权平均值',
			'sidebar/mapMore/minFilterOptions/linearMipmapNearestFilter': '取最匹配MipMap的相邻像素加权平均值',
			'sidebar/mapMore/minFilterOptions/linearMipmapLinearFilter': '取2个最匹配MipMap的相邻像素加权平均值的加权平均值',
			'sidebar/mapMore/magFilterLabel': '放大滤镜(magFilter)',
			'sidebar/mapMore/magFilterOptions/nearestFilter': '取最接近像素值',
			'sidebar/mapMore/magFilterOptions/linearFilter': '(默认)取相邻像素加权平均值',
			'sidebar/mapMore/mappingLabel': '映射模式(mapping)',
			'sidebar/mapMore/mappingOptions/uvMapping': '(默认)纹理网格坐标映射',
			'sidebar/mapMore/mappingOptions/cubeReflectionMapping': '基于环境盒子贴图的反射映射',
			'sidebar/mapMore/mappingOptions/cubeRefractionMapping': '基于环境盒子贴图的折射映射',
			'sidebar/mapMore/mappingOptions/equirectangularReflectionMapping': '基于经纬线映射贴图的反射映射',
			'sidebar/mapMore/mappingOptions/equirectangularRefractionMapping': '基于经纬线映射贴图的折射映射',
			'sidebar/mapMore/mappingOptions/cubeUVReflectionMapping': '基于环境盒子贴图纹理网格坐标的反射映射',
